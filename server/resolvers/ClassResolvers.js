...
const ClassResolvers = {
  Mutations: {
    ...
    changeDay: {
      ...
      resolve: async ({
        args: { className, schoolName, dayIndex, newSchedule },
      }) => {
    ...
    addAnnouncement: {
      ...
      resolve: async ({
        args: { content, className, student_id, schoolName },
      }) => {
        try {
    ...
    updateAnnouncement: {
      ...
      resolve: async ({
        args: { className, schoolName, announcementId, updates },
      }) => {
        ...
        if (updatedAnnouncement) {
          return updatedAnnouncement.find(
            (e) => e._id.toString() === announcementId
          );
        } else {
    ...
    removeOldAnnouncements: {
      ...
      resolve: async ({ args: { className, schoolName } }) => {
        try {
          ...
          const removedAnnouncementsIds = removedAnnouncements.map(
            ({ _id }) => _id
          );
    ...
    addHomework: {
      ...
      resolve: async ({
        args: { className, schoolName, student_id, content },
      }) => {
        if (content.attachments) {
          for (const attachment of content.attachments) {
            delete attachment._id;
    ...
    updateHomework: {
      ...
      resolve: async ({
        args,
        args: { className, schoolName, homeworkId, updates },
      }) => {
        try {
          const Class = await DataBase.getClassByName(className, schoolName);
  ...
  Queries: {
    ...
    getAnnouncements: {
      ...
      resolve: async ({
        args: { className, schoolName, date, requestingUserVkId },
      }) => {
